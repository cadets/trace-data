...
#git clone allendale:testRcv2/cadets-ci localRcv1/cadets-ci     # to be client for server elsewhere
sudo -u skalik git clone blackmarsh3:tc/cadets-ci localRcv2/cadets-ci     # to serve to own client
